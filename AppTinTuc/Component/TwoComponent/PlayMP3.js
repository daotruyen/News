...
const img_speaker = require('../../Assets/ui_play.png');
...
const img_playjumpright = require('../../Assets/ui_playjumpright.jpeg');

export default class PlayerMP3 extends React.Component{
    ...
    plays = async () => {
        ...
        if(this.sound){
            ...
            // const filepath = this.props.navigation.state.params.linkMp3;
            const filepath = 'https://v.vnecdn.net/vnexpress/video/audio/2021/07/31/khong-du--ma-nh-me--buong-bo--du--cho-ng-ba-t-pha--thai-va--lien-tie-p-ngoa-i-ti-nh-1627700219.mp3'
    ...
    render(){
        const { linkMp3 } = this.props.route.params;
        //console.log(linkMp3)
        ...
        return (
            <View style={{flex:1, justifyContent:'center', backgroundColor:'black'}}>
                ...
                <View style={{flexDirection:'row', justifyContent:'center', marginVertical:15}}>
                    ...
                    <TouchableOpacity onPress={this.plays} style={{marginHorizontal:20}}>
